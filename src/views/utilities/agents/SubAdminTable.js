...
export default function SubAdminTable({_id}) {
  ...
  const getAgentDetails = async () => {
    ...
    const inputparameters = {
      ...
      field,
      sortby,
      _id: _id // Add type filter if filterType is defined
    };

    try {
      const response = await axios.post(`${BackendURL}agents/gettingAdminNOperatorDetails`, inputparameters, { headers });
