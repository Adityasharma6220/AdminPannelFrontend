...
import {
  Paper, Table, TableBody, TableContainer, TableHead, TableRow, Box, TextField, MenuItem, Grid, Pagination,
...
export default function UserTransactions({ userId }) {
  ...
  const getUserDetails = async (startDate, endDate) => {
    ...
    try {
      let response = await axios.post(`${BackendURL}transactions/getTransactionUserWise`, inputparameters, { headers: headers });
